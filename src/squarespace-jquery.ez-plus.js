    ...
    var EZP = {
        ...
        fetch: function (imgsrc, element, minZoom) {
            ...
            newImg.onload = function () {
                ...
                if (newImg.width / element.width() <= minZoom) {
                    self.largeWidth = element.width() * minZoom * 2;
                } else {
                    self.largeWidth = newImg.width * 2;
                }
                if (newImg.width / element.height() <= minZoom) {
                    self.largeHeight = element.height() * minZoom * 2;
                } else {
        ...
        startZoom: function () {
			...
			if(self.options.debug) {
				console.log("Current Zoom Level "+ self.currentZoomLevel);
			}
        ...
        changeZoomLevel: function (value) {
			...
			if(self.options.debug) {
				console.log('zoom level: ' + newvalue);
			}
        },
